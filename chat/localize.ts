...
Any existing FChat 3.0 data for this character will be overwritten.`,
    ...
    'rising.filter.hideAds': 'Hide ads from matching characters',
    'rising.filter.hideSearch': 'Hide matching characters from search results',
    'rising.filter.hideMembers': 'Hide matching characters from channel members lists',
    'rising.filter.hidePubChat': 'Hide public channel messages from matching characters',
    'rising.filter.hidePrivChat': 'Hide private channel messages from matching characters',
    'rising.filter.hidePMs': 'Hide private messages (PMs) from matching characters',
    'rising.filter.showIcon': 'Show filter icon on matching characters',
    'rising.filter.automate': 'Send an automatic "no thank you" to matching characters if they message you',
    'rising.filter.penalize': 'Penalize match scores for matching characters',
    'rising.filter.reward': 'Increase match scores for non-matching characters',
    ...
    'rising.exceptions': 'Filters are not applied to these character names. Separate names with a linefeed. Friends and bookmarked characters bypass filtering automatically.',
